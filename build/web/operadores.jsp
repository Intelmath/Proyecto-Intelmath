<%-- 
    Document   : operadores
    Created on : 13/08/2019, 09:14:35 AM
    Author     : USER
--%>
...
<body class="bk">
   ...
   <header>
    <form action="biblioteca.jsp">
       ...
       <h1 class="bib"> <img src="IMG/icons8-math-100.png" alt="Logo Cerebro">&nbsp &nbsp Operadores</h1>
     </header>
     ...
     <%
                    ...
                    con.ObtenerConexion();
                    String sql="select * from tbl_biblioteca where tipo= 'Libro Matematicos';";
